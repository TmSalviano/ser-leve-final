...
export class NotificacaoController {
  ...
  async postou(@Param('usuarioId') usuarioId: number, @Param('postId') postId: number) {
  ...
  async curtiu(@Param('usuarioId') usuarioId: number, @Param('receitaId') receitaId: number) {
  ...
  async perfilAtualizado(@Param('usuarioId') usuarioId: number) {
  ...
  async teSeguiu(@Param('usuarioId') usuarioId: number, @Param('followerId') followerId: number) {
  ...
  async mensagemRecebida(@Param('usuarioId') usuarioId: number, @Param('senderId') senderId: number) {
  ...
  async getLatestNotifications(@Param('usuarioId') usuarioId: number) {
  ...
  async deleteNotificationsSentTo(@Param('usuarioId') usuarioId: number) {
  ...
  async deleteNotificationsSentBy(@Param('usuarioId') usuarioId: number) {
    await this.repo.deleteNotificationsSentBy(usuarioId);
